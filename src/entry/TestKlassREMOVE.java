...
public class TestKlassREMOVE {
    ...
    public void TestKlass(MyCompany myCompany) {
        ...
        myCompany.addBusinessAssociate(new Associate("J�rgen Klinsman", LocalDate.of(1973, 10, 25), telia, "CEO",
...
//                new ContactInfo("pitt@telia.se", "Fury Street", "010-131313")));
        ...
        myCompany.addBusinessAssociate(new Associate("Beyonc� Knowles-Carter", LocalDate.of(1981, 9, 04), volvo, "Staff",
...
//                new ContactInfo("xxx@com.com", "Bajsgatan", "112")));
        ...
        Meeting meetingA = new Meeting("TestM�te1", tempEmployeee, startDate, endDate);
        Meeting meetingB = new Meeting("TestM�te2", tempEmployeee, LocalDateTime.now(), LocalDateTime.now());
        Meeting meetingC = new Meeting("TestM�te3", tempEmployeee, LocalDateTime.now(), LocalDateTime.now());
        Meeting meetingD = new Meeting("TestM�te4", tempEmployeee, LocalDateTime.now(), LocalDateTime.now());
        Meeting meetingE = new Meeting("TestM�te5", tempEmployeee, LocalDateTime.now(), LocalDateTime.now());
